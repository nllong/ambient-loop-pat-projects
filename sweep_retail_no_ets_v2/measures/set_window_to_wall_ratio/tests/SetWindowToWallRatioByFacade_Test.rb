...
class SetWindowToWallRatio_Test < Test::Unit::TestCase
  ...
  def test_SetWindowToWallRatio_fail
     
    # create an instance of the measure
    measure = SetWindowToWallRatio.new
  ...
  def test_SetWindowToWallRatio_with_model
  ...
  def test_SetWindowToWallRatio_with_model_RotationTest
  ...
  def test_SetWindowToWallRatio_with_model_MinimalCost
  ...
  def test_SetWindowToWallRatio_with_model_NoCost
  ...
  def test_SetWindowToWallRatio_ReverseTranslatedModel
  ...
  def test_SetWindowToWallRatio_EmptySpaceNoLoadsOrSurfaces
