...
# start the measure
class ShiftScheduleProfileTimeTest < OpenStudio::Measure::ModelMeasure
  # define the name that a user will see, this method may be deprecated as
  # the display name in PAT comes from the name field in measure.xml
  def name
    return 'Shift Schedule Profile Time Test'
  end
...
ShiftScheduleProfileTimeTest.new.registerWithApplication
